...
func parseFlags() *config {
  ...
  a.Flag("pg-commit-secs", "Write data to database every N seconds or N Rows").Default("15").IntVar(&cfg.pgPrometheusConfig.CommitSecs)
  a.Flag("pg-commit-rows", "Write data to database every N Rows or N Seconds").Default("20000").IntVar(&cfg.pgPrometheusConfig.CommitRows)
